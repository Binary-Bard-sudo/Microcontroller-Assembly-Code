...
; CONFIG OFF             ; Watchdog Timer Enable bit (WDT disabled (control is placed on the SWDTEN bit))
...
; Program Code
   ...
   ;The 16 bit numbers is 3CE7 & 3B8D 
   ...
   MOVLW 0xE7     ;Load low byte
   ADDWF 6H,F     ; F = E7+8D=74 AND CARRY(C)=1
   MOVLW 0x3C     ;Load high byte
   ADDWFC 7H,F    ; F = 3C+3B+1(C)=78 (ALL IN HEX)
   HERE GOTO HERE
END
